...
((([0-9]+)|([0-9]*\.?[0-9]+))([eE][-+]?[0-9]+)?)   { lypsynlval.str = strdup(yytext); return TK_NUM; }
((([0-9]+)|([0-9]+\.)))                            { lypsynlval.str = strdup(yytext); return TK_NUM; }
[a-zA-Z]([a-zA-Z0-9_])*                            { lypsynlval.str = strdup(yytext); return TK_ID; }

\".*\"          { lypsynlval.str = strdup( yytext ); return TK_STR; }
